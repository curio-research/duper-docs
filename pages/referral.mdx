...
Starting in [Season I](/season-1), the Duper Referral Program is in effect. The referral program is standalone from seasons and will evolve separately from them, including Season I.

## How does it work?

- Each player has 1 unique referral code, unlimited use. Find yours on your Profile page.
- Each person you refer gives ETH and Sparks rewards for 2 months based on their gameplay, especially in Ranked mode.
