...
- If you've signed up but don't play for the week, all bets on you will be refunded.
...
- Leaderboard is ordered by league game total net payout (0 if net payout is negative).

### Prizes

- Per week
  - Abstract XP: 5x compared to normal Ranked games
  - Top earner gets 1 Gold Key; other competitors with positive net payout get 2 Silver Keys each; rest get 1 Silver Key each
...
- Bet on who makes the highest net payout across this week's Ranked games times a multiplier + League games with parimutuel odds.
- Betting more than 50 Chips will get you 1 Silver Key.
