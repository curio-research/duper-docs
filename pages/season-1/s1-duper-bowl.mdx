...
The Duper Bowl is live now! Visit the [Duper Bowl page](https://www.duper.gg/duperbowl) to compete or bet on players. Below are the specs for this first Duper Bowl.
...
- Edge case
  - If the number of competitors do not make multiples of 5 for a specific game window, the current players with the highest balances (\<5) will not be put into a game. Because of their high balance, they will not be eliminated until the next game window, and this will not count as a miss.
