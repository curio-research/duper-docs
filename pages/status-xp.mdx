# Status and XP [Under Maintenance]

**<u>Note: This page is under maintenance and will be updated soon.</u>**
...
Note: Status is purely a function of gameplay and balance, and is not tied to performance like typical game ranking systems. Therefore, anyone can get Super Duper status, including you!
...
- Ranked entry fee: \$10 = 10 XP
  - For example, for a Ranked game you played without raising, you earn exactly 10 XP
- Casual entry fee: \$2 = 2 XP
- Gold Key purchase: purchase value in USD

Volume XP from the last season is discounted with a 0.7x multiplier. There is no limit to the number of XP you can earn from volume.

### XP from Balance

Deposit balance to get the same amount of XP up to 2,500. For example, \$1,500 balance yields 1,500 XP.

XP from this source is live updated with your balance.
...
- 3000+ XP -> Gold
  - Unlock: +1 starting emblem point in Ranked
- 1200+ XP -> Silver
...
In addition, if you reach 8,000 XP, you will get a one-time Duper Maxi soulbound badge.
