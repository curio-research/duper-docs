...
This is a short player guide to help you get started playing Duper. Duper has a lot of strategic depth, but you can start playing with just a few key concepts.

**<u>This is the only page you need before playing your first Duper session.</u>** After finishing this Quick Start page, go on the [game website](https://play.duper.gg) and try the Playground mode. Explore the actions first, then try to beat the AI. Don't be frustrated if you fail in the first few trys — most people do!

After you've beaten the AI, you may play against real players in a Casual session. This is without real money, so you can continue practicing your skills and observing how the social diplomacy plays out. When you feel comfortable, transfer some Arbitrum ETH into your Privy wallet and deposit it into the game contract to play a Ranked session. Survive the lies ✦

TODO: Video

### What is Duper?

**Duper is an onchain stake-based social war game.** It contains elements from Poker, strategy games like Civilization and Into the Breach, and board games like Diplomacy and Catan.
