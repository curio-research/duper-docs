...
1. Create an account on [duper.gg](https://www.duper.gg) OR install Duper from [App Store](https://apps.apple.com/us/app/duper-social-war-game/id6748410227) or [Google Play](https://play.google.com/store/apps/details?id=com.CurioResearch.Duper) (currently US-only)
2. Finish the tutorials
