...
Duper is a 5-player free-for-all social war game with native stakes. Imagine a game where you strategize like TFT, trade like Catan, deceive like Among Us, and wager like Poker—that's Duper in a nutshell, and people love it. A game session typically lasts 25-40 minutes. There's a free-to-play mode, but the real fun comes with real money stakes.

Check out this video by Aesah, TFT Rank 1 Challenger and now an avid Duper player:
<YouTube id="CtORUaHitp8" />

### When can I play?

- **Ranked (0.005 ETH buy-in)**: 4+ windows hosted per week. Stay tuned on the game website.
...
Own 11 tiles or hold a 5-card _straight flush_ (see [Cards](./wiki/fundamentals/resources#cards) section) for one round to win and end a game.
