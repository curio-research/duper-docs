...
Duper is an onchain wagering social war game, inspired by games like Poker, Into the Breach, and Diplomacy. Duper is a game where you can not only have fun, but also earn money by outmaneuvering others.
...
A session ends when a player either owns 12 tiles or collects a 5-card _straight flush_ (for what this means, see the [Resources](./wiki/fundamentals/resources#cards) page). That player is referred to as the "settler". The payouts are then settled in the following manner:
