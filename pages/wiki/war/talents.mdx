...
| :--------------- | :------------------------------------------------------------------------------------------------------------ |
| Economist        | trade with non-adjacent players unlocked + 1 extra gold yield per round + ability to host Economic Conference |
| Plane Researcher | Player gets 1 free plane                                                                                      |
| Fort Researcher  | Player gets 1 free fort                                                                                       |
...
A player's first talent class takes 2 rounds to activate; second takes 4 rounds; third takes 5 rounds. This is not affected by how many research centers of the same talent class the player may own from conquering others'. In the above case, the fort researcher would take 5 rounds to activate.
