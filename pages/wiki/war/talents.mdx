...
A player may dedicate a newly built research center to 1 of 3 talent classes, provided that the player does not already have another research center dedicated to the same talent class. For example, if a player already has 2 research centers dedicated to plane researchers and 1 research center dedicated to an economist, the player may only build 1 more research center and can only dedicate it to a fort researcher.

The talent which an research center is dedicated to takes $(2 + \# \text{buildings owned by player})$ rounds to activate. In the above case, the fort researcher would take 5 rounds to activate.
