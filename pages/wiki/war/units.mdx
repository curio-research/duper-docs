...
| Plane                      | 3 gold, 1 3-card flush, 1 plane blueprint | capital lv1-3  | air      | 7                | 4        | 3                     | can perform long-distance moves and attack; can load |
| Fort                       | 3 gold, 1 3-card flush, 1 fort blueprint  | anywhere       | building | 0                | 7        | 6                     | can initiate attacks; can support with tanks inside  |
| Research center            | 1 3-card straight                         | anywhere       | building | 0                | 1        | 6                     |                                                      |
...
- Tanks can support: The strengths of tanks on a tile may be included in battles (both attacks and defenses) involving adjacent tiles owned by the same player.
