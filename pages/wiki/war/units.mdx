...
| Fort                       | 3 gold, 1 3-card flush, 1 fort researcher or blueprint  | anywhere       | building | 0                | 7        | same as troops inside but only dies if all troops inside die                     | can initiate attacks; can support if tanks inside  |
