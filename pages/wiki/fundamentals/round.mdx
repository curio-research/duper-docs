...
A player may only attack during their own turn, but may perform any other action such as production or trading outside of their turn. A session starts from Round 1. In each round, starting from the middle player, each player has their turn in a fixed sequence. Turns are shorter in early game and longer in late game.
