...
Each non-dealer player starts with 10 gems; the dealer starts with 13 gems. Gems are never destroyed, but players may mint new ones if they raise. Gems are semi-fungible in the sense that the minter of each gem matters, but the “index” of each gem does not.
