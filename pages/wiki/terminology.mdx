...
- When a player meets a **_victory condition_**, the session ends and the prize pool is divided as payouts to the players based on gem ownership of the **_winner_**'s.
