...
- Then, the rest of the pool is divided into $N$ equal chunks where $N$ is the number of total gems minted by the winner. The chunks are then distributed to the current owners of the winner-minted gems.
