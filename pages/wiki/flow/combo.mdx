...
During a game session, a player may commit more capital as entry fee to get more keys for greater risk but also greater potential return. This action is called "raising". A player is given an opportunity to raise only when a player wins a combo reward.
