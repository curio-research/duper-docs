...
| ---------------- | ---------------------- | ------------------------------------------------- | --------------------------------------------------- | --------------------------------- |
| Buy blueprint    | 1 chosen blueprint     | 1 initiator-minted gem                            | adjacent to recipient OR has economist              | only during trading window beginning of round; cannot use if chose swap cards |
| Swap cards       | 1 chosen card          | 1 provided card + 1 initiator-minted gem + 1 gold | adjacent to recipient OR has economist              | only during trading window beginning of round; cannot use if chose buy blueprint |
