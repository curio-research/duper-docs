...
- Ranked loss raffle: Every 3 Ranked losses (i.e. Ranked games with negative net payout) gives a raffle for up to a 10-Chip voucher
- Casual loss raffle: Every 3 Casual losses (i.e. Casual games with negative net payout) gives a raffle for up to 100 Sparks
