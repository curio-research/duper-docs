...
- 🎯 Enhanced matchmaking and more game windows
- 💎 Refined season pass rewards system
- 💳 Bank payments/withdrawals for US players (arriving by end of May)
...
- 🏆 Milestone Rewards (more for Platinum)
  ...
  - Sparks
- 🎲 Raffle Rewards
  - Every 2-loss streak in Ranked/Casual
- 🦄 Quests & Daily Claims
...
Note: Platinum milestone rewards cannot be claimed retroactively, so upgrade early for maximum benefits.
...
#### Balance Option 1: Gameplay Contribution
