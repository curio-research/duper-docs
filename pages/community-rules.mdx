...
2. You may not abuse the in-game chat with spam, hateful, or explicit content.
3. You may not ask others about their contact information in game.
4. Any intentional exploitation of confirmed temporary bugs to gain an unfair advantage over other players will result in enforcement action, as such behavior is considered a violation of the rules.
...
2. Payouts must not be settled outside of game. Received payouts for a game by a player must reflect the key distribution at the end of the game. This is to prevent self-sacrificial schemes to help a particular player end game, which would be unfair to the other players.

Violations of the above rules may result in reward slashing or account suspension when detected, depending on the severity of the violations. Any fraudulent activity detected and confirmed on any account or its transaction history can lead to slashing/deduction of funds.
...
The Community Rules can also be found in Duper's [Terms and Conditions](https://www.duper.gg/assets/terms-of-use-8a866037.pdf).
...
Yes! Community Rules exist in the first place to create a fair environment for our players. Please open a ticket in Discord and we’ll help you there.
