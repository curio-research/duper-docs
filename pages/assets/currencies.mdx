...
- Each Chip voucher can only be used in a game mode with entry fee at least its value. For example, you cannot use 5-Chip or 10-Chip vouchers in Casual games, where the starting entry fee is 1 Chip. 
