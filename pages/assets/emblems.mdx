...
Emblems will be NFTs starting from [Season IV](./season-4.mdx). Genesis lootbox holders will be able to claim free emblems, and Genesis Ace holders will get emblems airdrop.

We're revealing four kinds of emblems for players to use in Season IV (see below). Two of them have commander focus, one has cardmaster focus, and one has magician focus.
