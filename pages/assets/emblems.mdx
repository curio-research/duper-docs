...
Energy is the required for using emblems in addition to added entry fees. Players can accumulate up to 5 energy. Everyone starts with 1 energy that gets refilled by 1 every round.

In Ranked games, every time a player uses Emblems, everyone else's energy gets refilled by 1.
