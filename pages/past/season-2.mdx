...
During [Season I Duper Bowl](./past/season-1/s1-duper-bowl-betting.mdx), a whopping 200,000 Sparks were bet on competitors in 3 intense rounds of betting. In Season II, we're combining higher-entry games and player betting with the existing cadence of Wednesday townhalls. Each townhall will host 1-2 high-entry games where speculators can bet Sparks on players for potential earning.

- Townhall time: Every Wednesday 7-9am PT (may change after US daylight saving time ends)
- Tentative game ante: 0.025 ETH (\~$65)
- Procedure
  - Players register for townhall games until 1 hour before, i.e. by Wednesday 6am PT, by committing 0.005 ETH. The committed amount is returned if the player shows up. You're incentivized to register early so that others will have a chance to bet on you.
...
- Betting details
  ...
  - The rest of the Sparks are distributed proportionally based on the earning players' earn percentage. Here's an example:
    | Player      | Net Payout Across 2 Games (ETH) | Total Bet on Player (Sparks) |
    | :---------- | :----------------------------: | :----------------------------: |
    | A |               +0.05                | 2,000 |
    | B |               +0.04                | 4,000 |
    | C |               0                | 1,000 |
